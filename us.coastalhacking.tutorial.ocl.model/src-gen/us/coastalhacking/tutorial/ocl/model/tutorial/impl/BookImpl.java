 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.tutorial.ocl.model.tutorial.impl.BookImpl#getName <em>Name</em>}</li>
 *   <li>{@link us.coastalhacking.tutorial.ocl.model.tutorial.impl.BookImpl#getCopies <em>Copies</em>}</li>
 *   <li>{@link us.coastalhacking.tutorial.ocl.model.tutorial.impl.BookImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link us.coastalhacking.tutorial.ocl.model.tutorial.impl.BookImpl#getLoans <em>Loans</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BookImpl extends MinimalEObjectImpl.Container implements Book {
	...
	public EList<Loan> getLoans() {
		...
		/*@Thrown*/ SetValue.Accumulator accumulator = ValueUtil.createSetAccumulatorValue(TutorialTables.SET_CLSSid_Loan);
		/*@Nullable*/ Iterator<Object> ITERATOR__1 = BOXED_loans.iterator();
		...
		final /*@Thrown*/ List<Loan> ECORE_select = ((IdResolver.IdResolverExtension)idResolver).ecoreValueOfAll(Loan.class, select);
	...
	public Boolean isAvailable() {
		...
		final /*@NonInvalid*/ IntegerValue BOXED_copies = copies == null ? null : ValueUtil.integerValueOf(copies);
		final /*@Thrown*/ boolean lt = OclComparableLessThanOperation.INSTANCE.evaluate(executor, size, BOXED_copies).booleanValue();
		return lt;
	}
	...
	public boolean SufficientCopies(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ Executor executor = PivotUtilInternal.getExecutor(this);
		final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TutorialTables.STR_Book_c_c_SufficientCopies);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, TutorialTables.STR_Book_c_c_SufficientCopies, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, TutorialTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TutorialPackage.BOOK___IS_AVAILABLE:
				return isAvailable();
			case TutorialPackage.BOOK___SUFFICIENT_COPIES__DIAGNOSTICCHAIN_MAP_1:
